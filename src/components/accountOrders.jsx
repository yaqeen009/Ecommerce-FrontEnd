...
const OrderDetails = () => {
    return ( 
        <div className="account-orders mt-4 border-b border-font grid grid-cols-5 text-center mx-4 lg:mx-8">
            <p className="font-open_sans text-mobile-body md:text-tablet-body lg:text-body text-font">#0123456789</p>
